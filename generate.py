...
parser = argparse.ArgumentParser(
    description="Utility for text generation model evaluation."
)
parser.add_argument("--prefix", type=str, nargs="+", help="First words of sentence.")
parser.add_argument(
    "--model", type=Path, default="model.pkl", help="File for loading model."
)
parser.add_argument("--length", type=int, default=7, help="Word of resulting sentence.")
parser.add_argument(
    "--log-level",
    default="ERROR",
